    ...
    return (
        <>
            <Text>
                ...
                <Text display='inline' color='#00462A'>염라대왕&nbsp;</Text>
                <Text display='inline' bottom='0px'>죽은 친구들</Text>
            ...
            <Wrapper>
                ...
                <BtnToPage exact to='/makers'><DeveloperPageLink><SmallText>궁금하다면? 클릭!</SmallText></DeveloperPageLink></BtnToPage>
            </Wrapper>
        </>
    );
}
