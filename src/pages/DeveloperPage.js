    ...
    return (
        <>
            <Text>
                ...
                <Text>🏠</Text>
                <Text display='inline-block' top='2.1rem' color='#00462A'>염라대왕</Text>
            ...
            <Wrapper>
                ...
                <Text top='1.7rem' bottom='19.4rem' font='Spoqa-Han-Sans' fontWeight='400' fontSize='1.2rem'></Text>
                <BtnToPage exact to='/'><ButtonComponent type={'others-activated'} text={'테스트 다시 하기'} /></BtnToPage>
                <BtnToPage exact to='/all'><ButtonComponent type={'others-unactivated'} text={'다른 수명 유형 구경하기'} /></BtnToPage>
            </Wrapper>
        </>
    );
}
