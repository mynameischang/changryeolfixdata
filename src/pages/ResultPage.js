            ...
            <Wrapper backgroundColor={results[finalType].color}>
                <Container>
                    ...
                    <NormalResult isNormal={finalType}>
                        <Title>🏠 혹시, 나의 수명을 찾고 있나요?</Title>
                        <FlexLayout>
                            <MatchElement>
                                <SubTitle>좋네요~</SubTitle>
                                <MatchSqaure>
                    ...
                    <FlexLayout>
                        <ShareSquare>
                            ...
                            <BtnToPage exact to='/all'><ButtonComponent type={'result-unactivated'} text={'다른 수명 유형 구경하기'} /></BtnToPage>
                        </ShareSquare>
                    </FlexLayout>
